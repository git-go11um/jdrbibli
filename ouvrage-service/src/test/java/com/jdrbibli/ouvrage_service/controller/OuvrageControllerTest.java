...
class OuvrageControllerTest {
    ...
    void create_returnsCreatedDTO() {
        ...
        returnedDto.setTitre("T1");
        returnedDto.setOwnerId(42L);
    ...
    void uploadImage_success() throws IOException {
        ...
        // ✅ compatible Jenkins (chemin absolu possible dans Docker)
        assertThat(res.getBody()).contains("uploads");
    }
    ...
    // ---------- FRIEND LIBRARY ----------
    @Disabled("Mock WebClient à implémenter ultérieurement")
    @Test
